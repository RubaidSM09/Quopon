  ...
  Future<void> _checkIfSaved() async {
    ...
    try {
      ...
      final resp = await BaseClient.getRequest(
        api: 'https://doctorless-stopperless-turner.ngrok-free.dev/vendors/wish-deals/',
        headers: headers,
      );
  ...
  Future<bool> removeFromWishlist() async {
    ...
    try {
      ...
      final resp = await http.delete(
        Uri.parse('https://doctorless-stopperless-turner.ngrok-free.dev/vendors/wish-deals/$id/'),
        headers: headers,
      );
