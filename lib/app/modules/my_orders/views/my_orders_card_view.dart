...
class MyOrdersCardView extends GetView {
  ...
  final String status; // Added to determine if "Track Order" should be shown
            ...
            children: [
              ClipRRect(
                ...
                child: Image.network(
                  ...
                  height: 72.h,
                  width: 72.w,
                  errorBuilder: (context, error, stackTrace) => Icon(Icons.error, size: 72.sp),
                ),
              ),
              SizedBox(width: 12.w),
              Column(
          ...
          Row(
            ...
            children: [
              GradientButton(
                ...
                width: status == 'COMPLETED' || status == 'CANCELLED' ? 374.w : 181.w, // Full width if no Track button
                height: 42.h,
                borderRadius: 12.r,
                child: Text(
                  'View Details',
              ...
              if (status != 'COMPLETED' && status != 'CANCELLED') // Show Track Order only for non-completed/cancelled
                GradientButton(
                  text: 'Track Order',
                  onPressed: () {
                    print(orderId);
                    Get.to(TrackOrderView(), arguments: orderId);
                  },
