...
class DeliveredView extends GetView<MyOrdersVendorsController> {
  DeliveredView({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      var filtered = controller.orders.where((o) => o.deliveryType == 'DELIVERY' && o.status == 'DELIVERED' && isDateMatch(selectedDate.value, o.createdAt)).toList();
      return Column(
        children: [
          Row(
            children: [
