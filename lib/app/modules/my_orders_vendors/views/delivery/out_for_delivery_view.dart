...
class OutForDeliveryView extends GetView<MyOrdersVendorsController> {
  OutForDeliveryView({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      var filtered = controller.orders.where((o) => o.deliveryType == 'DELIVERY' && o.status == 'OUT_FOR_DELIVERY' && isDateMatch(selectedDate.value, o.createdAt)).toList();
      return Column(
        children: [
          Row(
            children: [
