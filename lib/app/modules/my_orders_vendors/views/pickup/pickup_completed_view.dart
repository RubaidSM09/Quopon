...
class PickupCompletedView extends GetView<MyOrdersVendorsController> {
  PickupCompletedView({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      var filtered = controller.orders.where((o) => o.deliveryType != 'DELIVERY' && o.status == 'COMPLETED' && isDateMatch(selectedDate.value, o.createdAt)).toList();
      return Column(
        children: [
          Row(
            children: [
