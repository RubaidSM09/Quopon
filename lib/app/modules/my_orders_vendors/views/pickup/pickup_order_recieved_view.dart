...
import '../delivery/delivery_order_received_view.dart';
import '../my_orders_vendor_card_view.dart';

class PickupOrderRecievedView extends GetView<MyOrdersVendorsController> {
  PickupOrderRecievedView({super.key});
