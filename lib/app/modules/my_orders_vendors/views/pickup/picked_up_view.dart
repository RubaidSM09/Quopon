...
class PickedUpView extends GetView<MyOrdersVendorsController> {
  PickedUpView({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      var filtered = controller.orders.where((o) => o.deliveryType != 'DELIVERY' && o.status == 'PICKED_UP' && isDateMatch(selectedDate.value, o.createdAt)).toList();
      return Column(
        children: [
          Row(
            children: [
