...
class ReadyForPickupView extends GetView<MyOrdersVendorsController> {
  ReadyForPickupView({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      var filtered = controller.orders.where((o) => o.deliveryType != 'DELIVERY' && o.status == 'READY_FOR_PICKUP' && isDateMatch(selectedDate.value, o.createdAt)).toList();
      return Column(
        children: [
          Row(
            children: [
