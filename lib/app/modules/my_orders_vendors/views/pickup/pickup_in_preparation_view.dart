...
class PickupInPreparationView extends GetView<MyOrdersVendorsController> {
  PickupInPreparationView({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      var filtered = controller.orders.where((o) => o.deliveryType != 'DELIVERY' && o.status == 'PREPARING' && isDateMatch(selectedDate.value, o.createdAt)).toList();
      return Column(
        children: [
          Row(
            children: [
