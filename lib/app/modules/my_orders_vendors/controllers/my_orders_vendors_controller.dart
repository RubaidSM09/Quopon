...
class MyOrdersVendorsController extends GetxController {
  ...
  Future<void> updateOrderStatus(String orderId, String newStatus) async {
    final url = Uri.parse('https://doctorless-stopperless-turner.ngrok-free.dev/order/orders/$orderId/status/');
    try {
  ...
  Future<void> cancelOrder(String orderId, String cancellationReason) async {
    final url = Uri.parse('https://doctorless-stopperless-turner.ngrok-free.dev/order/orders/$orderId/cancel/');
    try {
      final response = await http.post(
        url,
        headers: await ApiClient.authHeaders(),
  ...
  Future<bool> verifyDelivery(String orderId, String code) async {
    final url = Uri.parse('https://doctorless-stopperless-turner.ngrok-free.dev/order/orders/$orderId/verify-delivery/');
    try {
      final response = await http.post(
        url,
        headers: await ApiClient.authHeaders(),
